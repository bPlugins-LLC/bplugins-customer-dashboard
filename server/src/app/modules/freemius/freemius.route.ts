...
import { deactivateLicense, getCollectionById, getFreemiusUser, getInstalls, getPluginDownloadLink, getPluginTags, getPlugins, tempControllerDirectPath, useUserKey } from "./freemius.controller";
